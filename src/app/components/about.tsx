...
const About = () => {
  return (
    <div className="bg-white ">
      <h1 className="text-sky-800 font-bold text-2xl text-center mx-14 mb-6 xl:mt-6 xl:text-3xl font-sans">
      ...
      <p className="text-black mx-6 text-lg font-medium text-center xl:text-xl 2xl:text-2xl">
      ...
      <div className="mt-10 space-y-9 md:space-y-0 md:ml-16 md:flex place-items-center gap-5">
        <Image
        src={slideShow1}
        alt="Slideshow-Image"
        className="w-full h-[300px] rounded-lg md:h[600px] object-cover shadow-2xl shadow-black"
        ></Image>
        <Image
        src={slideShow2}
        alt="Slideshow-Image"
